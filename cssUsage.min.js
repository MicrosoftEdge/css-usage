...
void function () {
	...
	function GetAttributes(element, node) {
		var whitelist = ["aria-hidden", "aria-live", "aria-atomic", "aria-busy", "aria-disabled", "aria-expanded", "aria-sort", "aria-readonly", "aria-required", "aria-selected", "type", "dir", "disabled", "draggable", "lang", "role"];
