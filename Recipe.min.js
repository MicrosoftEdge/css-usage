    ...
    window.CSSUsage.StyleWalker.recipesToRun.push( function imgEdgeSearch( element, results) {
        ...
        if(element.nodeName == "IMG") {
            ...
            for(var i = 0; i < browsers.length; i++) {
                if(element.alt.toLowerCase.indexOf(browsers[i]) != -1|| element.src.toLowerCase.indexOf(browsers[i]) != -1) {
                    results[browsers[i].toString] = results[browsers[i].toString] || {count: 0};
                    results[browsers[i].toString].count++;
                }
        }   
        }
